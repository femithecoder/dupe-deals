...
/**
 * The branded share image generated by app/opengraph-image.tsx.
 *
 * The file convention attaches that image to the root layout's openGraph, and
 * a page that declares its own openGraph replaces the layout's outright, so
 * every page below the root segment has to carry the default itself or ship
...
const DEFAULT_OG_IMAGE = {
  ...
  width: 1200,
  height: 630,
  alt: `${SITE_NAME}. Quality products. Half the price.`,
}
