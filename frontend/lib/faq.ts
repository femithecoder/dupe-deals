...
export const faqs: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Every listing links directly to the retailer's own site (e.g. Boots, John Lewis, Currys, Argos, Dunelm) — you complete your purchase there. DupeDeals never handles payments or checkout itself.",
  },
  {
    id: "is-retailer",
  ...
  },
  {
    ...
    answer:
      "DupeDeals doesn't process orders, so we can't track them — your order and tracking details come from the retailer you purchased from. Check your confirmation email from them.",
  },
  {
    id: "payment-methods",
  ...
  },
  {
    ...
    answer:
      "We'd love that — head to our Submit a Deal page and fill in the product, link, and price. If it checks out, we'll feature it.",
  },
  {
    id: "contact",
  ...
  },
  {
    ...
    answer:
      "We collect basic usage data and anything you send us directly (like chat messages or emails) — we never sell your data. Full details are on our Privacy Policy page.",
  },
  {
    id: "cookies",
