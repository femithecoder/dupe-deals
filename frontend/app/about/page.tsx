...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Learn how DupeDeals finds UK shoppers cheaper alternatives to premium brands, how we test our picks, and why we only feature dupes we would buy ourselves.",
  path: "/about",
})
